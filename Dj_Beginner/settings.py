...
SECRET_KEY = 'django-insecure-@5s1)yw*(ubv=)#-9in#u*n)5q1=0o+-*@qwfufl!h-766)$pi'
...
WSGI_APPLICATION = 'Dj_Beginner.wsgi.application'
...
MEDIA_URL='/media/'
MEDIA_ROOT=os.path.join(BASE_DIR,'media')  #for images handle
